...
tweets.to_csv("Region 1 Construction Tweets.csv", encoding='utf-8', index=False)
...
script = ''''tell application "Finder"
	set folderPath to folder "Insert File Path"
	set theFile to first file in folderPath as alias
	set fileName to name of theFile
end tell
set theSubject to "Insert Subject"
set theBody to "Filename in attachment: " & fileName
set theAddress to "insert email"
